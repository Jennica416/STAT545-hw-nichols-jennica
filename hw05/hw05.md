...
# visualize re-ordered variable
  ggplot(gap2007, aes(country, lifeExp)) +
...
```r
ggsave("hw05_files/testPlot.png", plot = gapViz_plot, dpi = 600)
...
When I did not specify plot, I created the following image:
  
![Alt text](hw05_files/testPlot_bare.png)
